...
const Portfolio = () => {
  const WorkCards = [
    ...
    { id: 2, label: 'Business', title: 'Imagine Group', para: "Welcome to Imagine Group, where your property dreams become reality. Our team of experienced professionals offers personalized service and innovative solutions to make your real estate journey seamless. Discover a world of possibilities with Imagine Group.", url: 'http://imaginegindia.com', imgUrl: '/project-img-2.png' },
