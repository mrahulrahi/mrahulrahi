...
export default function WorkspacePage() {
    ...
    // If tab slug is unrecognized, redirect to default portfoliohub
    useEffect(() => {
        if (tabSlug && !slugToTab[tabSlug]) {
            router.replace('/workspace/portfoliohub');
        }
    }, [tabSlug, router]);
                            ...
                            <div className="space-y-8 w-full animate-pulse-once">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <button onClick={() => router.push('/workspace/ui-sandbox')} className="bg-slate-900/30 border border-slate-800 hover:border-brand-mint/30 p-5 rounded-2xl text-left transition-all hover:-translate-y-1 cursor-pointer group">
