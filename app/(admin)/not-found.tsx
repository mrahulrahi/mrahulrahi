    ...
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden px-6 py-20 bg-brand-black text-brand-text">
      ...
      <div className="max-w-2xl w-full text-center relative z-10 space-y-8">
        ...
        <motion.div 
          ...
          className="pt-6"
        >
          <Link href="/admin" className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-brand-mint hover:bg-brand-glow text-brand-black font-bold text-sm tracking-wide transition-all duration-300 shadow-[0_0_15px_-3px_rgba(0,220,130,0.3)] hover:shadow-[0_0_25px_rgba(0,220,130,0.5)]">
