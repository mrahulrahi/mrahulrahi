...
const Hero = ({ bgImg, title, subTitle, content, gradientColor }: HeroProps) => {
    return (
        <>
            <div className={`hero-container flex items-end relative rounded-3xl overflow-hidden ${!bgImg ? 'hero-bg-pattern min-h-[250px]' : 'min-h-[300px] lg:min-h-[400px]' }`} >
                {bgImg &&
                ...
                <div className={`hero-content w-full max-w-[calc(100%-60px)] h-full text-neutral-content mx-auto relative z-9 ${!bgImg ? "pt-20 pb-10" : 'py-20'}`}>
