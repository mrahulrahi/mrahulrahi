      ...
      <div
        ...
        <div style="padding: 40px 32px;">
          ...
          <div style="margin-bottom: 32px;">
            <div
              style="display: inline-block; background: #f8f9fa; padding: 20px 24px; border-radius: 12px; width: 100%; box-sizing: border-box;">
              <p
                style="margin: 0 0 12px 0; color: #6b7280; font-size: 13px; font-weight: 500; text-transform: uppercase; letter-spacing: 0.5px;">
                From</p>
        ...
        <div style="background: #f8f9fa; padding: 24px 32px; border-top: 1px solid #e5e7eb;">
          <div style="display: flex; align-items: center; justify-content: space-between;">
            <a href="https://mrahulrahi.vercel.app/"
              ...
              <img src="https://drive.google.com/file/d/1KhQOoliENvWbfatOnQLSk5XbF1znCS_f/view?usp=drive_link" alt="Logo"
