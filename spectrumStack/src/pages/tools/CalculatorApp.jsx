...
const CalculatorApp = () => {
    ...
    return (
        <div className="android-frame flex flex-col border-[0.425em] border-black rounded-[1.875rem] bg-[#151715] max-w-[400px] mx-auto">
            ...
            <div className="input-btn-wrapper pt-[30px] px-[10px] pb-[20px]">
                <div className="mini-algo-function flex justify-evenly text-auto w-full text-[#dfcee5] mb-3 gap-2.5">
                    <button onClick={handleButtonClick} className="button mini-function w-1/4 text-[#dfcee5] bg-[#4f4256] border-black rounded-[31.25rem] text-[1rem] font-semibold h-[2rem] active:rounded-[10%] ease-in">x²</button>
                    <button onClick={handleButtonClick} className="button mini-function w-1/4 text-[#dfcee5] bg-[#4f4256] border-black rounded-[31.25rem] text-[1rem] font-semibold h-[2rem] active:rounded-[10%] ease-in">√</button>
                    <button onClick={handleButtonClick} className="button mini-function w-1/4 text-[#dfcee5] bg-[#4f4256] border-black rounded-[31.25rem] text-[1rem] font-semibold h-[2rem] active:rounded-[10%] ease-in">π</button>
                    <button onClick={handleButtonClick} className="button mini-function w-1/4 text-[#dfcee5] bg-[#4f4256] border-black rounded-[31.25rem] text-[1rem] font-semibold h-[2rem] active:rounded-[10%] ease-in">^</button>
                    <button onClick={handleButtonClick} className="button mini-function w-1/4 text-[#dfcee5] bg-[#4f4256] border-black rounded-[31.25rem] text-[1rem] font-semibold h-[2rem] active:rounded-[10%] ease-in">!</button>
                </div>
